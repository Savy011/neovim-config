...
_G.packer_plugins = {
  ...
  ["nvim-markdown-preview"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/nvim-markdown-preview",
  ...
  ["vim-hexokinase"] = {
    loaded = true,
    needs_bufread = false,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/opt/vim-hexokinase",
